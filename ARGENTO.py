...
logger = logging.getLogger('ARGENTOCopyBot')

api_id = '23415626'
api_hash = '84407a767ffbbd9ce175bb9dba5948f2'

channel_pairs = [
    ('@traffic_ultras', -1002652573520),
    ('@free_traffs', -1002652573520),
    ('@nonamet9am', -1002652573520),
    ('@thepartnerkin', -1002652573520),
]
...
def remove_all_link_lines(message):
    ...
    if removed_any:
        inline_link = '<a href="https://t.me/+Xq5V2c0VMbdlOGNi">ARGENTO</a>'
        if new_text:
            new_text += "\n" + inline_link
        else:
